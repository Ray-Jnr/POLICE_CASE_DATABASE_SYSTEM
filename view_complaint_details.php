...
<body>
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<tr><td>" . $row["CaseNumber"]. "</td><td>" . $row["FullName"]. "</td><td>" . $row["IncidentType"]. "</td><td>" . $row["PlaceOfIncident"]. "</td>
            <td>" . $row["DateReported"]. "</td> 
            <td>                        <a class='btn btn-primary btn-sm' href='view_diaryofaction_details.php?id=$caseid'>View Diary of Action</a>
 </td> 
