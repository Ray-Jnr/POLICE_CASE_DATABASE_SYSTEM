...
if (!isset($_SESSION['ServiceNumber']) || $_SESSION['Role'] != 'CID' &&  $_SESSION['Role'] !='ADMIN') {
    header("location:psystem_homepage.php");
    exit();
}

// Page content for CID role
?>
    ...
    <form action="#">
      <div class="complaint_details">
        ...
        <div class="form_button">
          <button type="button" onclick="window.location.href='unauthorized.php'">Submit</button>
        </div>
      </div>
