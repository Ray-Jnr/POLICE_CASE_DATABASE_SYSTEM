...
<body>
    <div class="container my-4">
        <h2>Add user</h2>
        <a class="btn btn-primary" href="pysystem_settings.php" role="button">New User</a>
    </div>
    <!-- creating a table -->
    <table class="table">
        <thead>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class='btn btn-danger btn-sm' href='delete_user.php?id=<?php echo $row['id']; ?>'>Delete</a>
                    </td>
                </tr>
                <?php
            }
